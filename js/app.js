...
$('#getWeatherBtn').click(function () {
  ...
  $.ajax({
    type: 'GET',
    url: 'http://api.openweathermap.org/data/2.5/weather?q=' + cityName + '&appid=81dfa2ef7d52beae9fce6417cd6483ca',
...
$('#getForecastBtn').click(function () {
  ...
  $.ajax({
    type: 'GET',
    url: 'http://api.openweathermap.org/data/2.5/forecast?q=' + cityName + '&appid=81dfa2ef7d52beae9fce6417cd6483ca',
    success: function (data) {
